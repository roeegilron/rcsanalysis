function concatenate_and_plot_TD_data_with_params(dirname,params)
%% this function will concatenate some data given a few parameters 
% they are listed below: 
params.startdate = NaT; % date time of start of recordings 
params.endaate = NaT; % date time of start of recordings 
