...
toplot{1,1} = meanbetafreq{2,1}; % off stim 
toplot{1,2} = meanbetafreq{2,2}; % on stim 
[h,p] = ttest2(toplot{1,1},toplot{1,2});
fprintf('pval is %0.7f\n',p);
...
if ~plotpanels
%%    
figdirout = '/Users/roee/Starr_Lab_Folder/Writing/papers/2019_LongTerm_RCS_recordings/figures/1_draft2/Fig7_effect_of_stim_and_adaptive';
hpanel.fontsize = 10; 
