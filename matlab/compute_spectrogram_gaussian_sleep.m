function res = compute_spectrogram_gaussian_sleep(data,fs)
%% params
params.minimum_frequency = 0.1; %lowest freq to examine
params.maximum_frequency = 20; %highest freq to examine (remember Nyquist! <samplingrate/2 at least!)
params.number_of_frequencies = 20; %number of frequencies to look at
