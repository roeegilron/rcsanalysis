...
Samples of raw RC+S time domain data (in JSON format) and the processed "Tidy" data CSV output created from it are available in the `sample_data` folder of this repo.
